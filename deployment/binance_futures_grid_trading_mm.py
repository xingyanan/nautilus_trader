...
from high_frequency_grid_trading_mm import HighFrequencyGridTradingMM
from high_frequency_grid_trading_mm import HighFrequencyGridTradingMMConfig
...
strat_config = HighFrequencyGridTradingMMConfig(
...
strategy = HighFrequencyGridTradingMM(config=strat_config)
